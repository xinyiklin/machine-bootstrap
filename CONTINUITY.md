...
- 2026-08-14 [USER+CODE] Project templates have one canonical source and are
  ...
  verified run-owned files, leaves identity-changed concurrent entries at their
  original paths, restores in-place changes without dereferencing symlinks,
  never deletes directories by pathname, and reports exact recovery paths.
